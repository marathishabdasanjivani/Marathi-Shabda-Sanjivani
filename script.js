document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadHomepage() {
        ...
        // --- Daily WOTD Logic (Normal font, no examples) ---
        ...
        // Updated: Only definition, no bold, no example
        homeNode.querySelector('#wotdDefinition').innerText = dailyWord.meanings[0].definition;
